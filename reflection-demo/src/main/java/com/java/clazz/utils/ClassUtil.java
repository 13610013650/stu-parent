...
public class ClassUtil {
    ...
    private static ArrayList<Class> getAllClass(String packagename) {
        ...
        try {
             ...
             * 另外，路径中切不可包含空格、特殊字符等！
             */
            String path1 = classLoader.getResource("").getPath()+path;
            System.out.println("path1:"+path1);
            String substring = path1.substring(1, path1.length());
            System.out.println("substring:"+substring);
            Enumeration<URL> enumeration = classLoader.getResources(substring);
            System.out.println("enumeration.hasMoreElements():"+enumeration.hasMoreElements());
